 ...
 */
final class Version20230522205521 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD categorie_id INT NOT NULL, ADD magasin_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP categorie_id, DROP magasin_id');
    }
}
